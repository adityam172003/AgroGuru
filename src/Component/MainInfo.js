...
const MainInfo = () => {
  ...
  return (
    ...
    <section id="features_grid">
              ...
              <div class="fts ft1">
                <div class="fts_cnts" id="fts_cnt1">
                ...
                <div class="fts_imgs" id="fts_img1">
                    <div id="e1"></div>
                    <div id="e2"></div>
              ...
              s<div class="fts ft2">
                ...
                <div class="fts_cnts" id="fts_cnt2">
              ...
              <div class="fts ft3">
                <div class="fts_cnts" id="fts_cnt3">
                ...
                <div class="fts_imgs" id="fts_img3">
                    <div id="e1"></div>
                    <div id="e2"></div>
              ...
              <div class="fts ft4">
                ...
                <div class="fts_imgs" id="fts_img4">
                    <div id="e1"></div>
                    <div id="e2"></div>
                    <div id="e3"></div>
                    <img src="/assets/ft4_img.jpg" alt="" width="380rem"/>
                </div>
                <div class="fts_cnts" id="fts_cnt4">
              ...
              <div class="fts ft5">
                ...
                <div class="fts_imgs" id="fts_img5">
                    <div id="e1"></div>
                    <div id="e2"></div>
